...
$valid_path = "/connexion/administrateur";
...
$sql = "SELECT * FROM Administrateur WHERE utilisateur='$utilisateur' AND password='$password'";
...
if ($result->num_rows > 0) {
    ...
    $response['message'] = 'Authentification réussie en tant qu\'administrateur';
} else {
    // Authentification échouée
    $response['success'] = false;
    $response['message'] = 'Nom d\'utilisateur ou mot de passe incorrect pour un administrateur';
}
